...
//     await page.setContent(htmlContent, { waitUntil: ['domcontentloaded', 'networkidle0'], timeout: 30000 });
...
// let pdfGeneratorInstance = null;
// const getPDFGenerator = () => {
//   if (!pdfGeneratorInstance) pdfGeneratorInstance = new PDFGenerator();
//   return pdfGeneratorInstance;
// };

// process.on('SIGINT', async () => { if (pdfGeneratorInstance) await pdfGeneratorInstance.close(); process.exit(0); });
// process.on('SIGTERM', async () => { if (pdfGeneratorInstance) await pdfGeneratorInstance.close(); process.exit(0); });

// module.exports = { PDFGenerator, getPDFGenerator 
